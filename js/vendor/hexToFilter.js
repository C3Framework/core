...
export function hexToFilter(hex) {
    ...
    if (color.r === 255 && color.g === 255 && color.b === 255) {
        return 'brightness(0) saturate(100%) invert(100%) sepia(0%) saturate(1%) hue-rotate(157deg) brightness(102%) contrast(101%);';
    } else if (color.r === 0 && color.g === 0 && color.b === 0) {
        return 'contrast(100%) brightness(0%) saturate(0%)';
    }
